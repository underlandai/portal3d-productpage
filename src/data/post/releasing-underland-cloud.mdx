...
1.  **Step 1: Export & Upload:** Export your Open Mining Format (OMF) or GeoH5 (partially supported) file from your existing mining software and upload the 3D subsurface model through our secure web interface.
